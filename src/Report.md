...
Мульти модем (далее ММ) расположен на столе в центре офиса, в трех метрах от окна. В тестировании участвуют четыре симкарты операторов МТС, Билайн, Мегафон, Теле2. Наземный канал от Сибирских Сетей 100Мб, DHCP. 
...
Провели тестирование работоспособности при потере сигнала от сим-карт. При нескольких запущенных потоках udp, при потере сигнала от одной или нескольких сим-карт перестроение маршрутов происходит мгновенно. При потере сигнала от всех сим-карт и их подключении обратно, связь восстанавливается в течении нескольких секунд.
