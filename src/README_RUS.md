...
1. [Тестирование в режиме агрегации](#режим-агрегации) \
   2.1. [Тестирование скорости iperf3](#тестирование-скорости-iperf3) \
   2.2. [Тестирование агрегации](#агрегация)  
   2.3. [Адресация](#адресация) \
...
- TCP тест Download 60 сек каждый тест iperf.

<img src="../misc/23_script_test_stcp.png" alt="signal_lvl"/>

- TCP тест Upload 60 сек каждый тест iperf.
